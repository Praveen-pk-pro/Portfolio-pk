        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              I’m currently looking for internship and entry-level opportunities as well as freelance work. 
              Whether you have a project idea, an open position, or just want to connect, feel free to reach out!
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:pkpraveen83441234@gmail.com" className="text-white font-medium hover:text-accent transition-colors">pkpraveen83441234@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+916380953716" className="text-white font-medium hover:text-accent transition-colors">+91 6380953716</a>
                </div>
              </div>
