          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SKILLS.map((category, idx) => (
              ...
              <MotionDiv
                ...
                className="bg-card p-6 rounded-2xl border border-white/5 hover:border-accent/20 transition-all hover:-translate-y-1 group flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill) => (
                      <span 
                        key={skill}
                        className="px-3 py-1 bg-primary border border-white/10 rounded-full text-xs sm:text-sm text-gray-300 hover:text-white hover:border-accent/50 transition-all hover:scale-105 hover:bg-accent/5 cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
