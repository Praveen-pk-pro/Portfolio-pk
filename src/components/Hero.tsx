...
const Hero: React.FC = () => {
  ...
  const subtitleText = "STUDENT|FULL-STACK & AI AUTOMATION DEVELOPER";
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20 h-full flex flex-col justify-center">
        <div className="max-w-4xl">
          ...
          <div className="hero-subtitle min-h-[1.5em] mb-8 md:mb-12">
            <h2 ref={subtitleRef} className="text-xs sm:text-sm md:text-base font-mono font-medium uppercase tracking-[0.3em] pl-1 flex flex-wrap">
              {letters.map((char, i) => (
                <span 
                  key={i} 
          ...
          <div className="hero-desc flex flex-col gap-8 pl-1 max-w-xl">
            <p className="text-gray-400 text-sm sm:text-base leading-relaxed border-l border-white/20 pl-6 backdrop-blur-sm md:backdrop-blur-none">
              B.Tech IT Student (Class of 2028) & Freelance Developer based in Coimbatore, India. 
              Building real production systems — multi-tenant RAG SaaS platforms, WhatsApp lead distribution, and automated AI video pipelines.
            </p>
